  ...
  return (
    <main className="min-h-screen bg-transparent text-strong">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-14">
        {/* BIG CONTAINER PANEL (missing before) */}
        <div className="glass-panel elev-3 rounded-3xl p-8">
          {/* HERO */}
          <section className="glass-panel elev-1 rounded-3xl p-8">
            <h1 className="text-4xl font-semibold tracking-tight">Built to be quiet, reliable, and real</h1>

            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-muted">
              Soundscape is a deterministic ambient sound engine built from real-world recordings. It generates calm,
              realistic soundscapes without accounts, subscriptions, or algorithmic feeds.
            </p>

            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted">
              You choose a mood. You generate a mix. You export exactly what you need. Nothing changes unless you change
              it.
            </p>

            <div className="glass-panel mt-5 rounded-2xl p-4 text-xs text-faint">
              Playback is free. Credits are only used when you export.
            </div>
          </section>

          {/* WHAT IT IS */}
          <section className="glass-panel elev-1 mt-8 rounded-3xl p-8">
            <h2 className="text-2xl font-semibold tracking-tight">What Soundscape is</h2>

            <p className="mt-4 text-sm text-muted leading-relaxed">
              Soundscape is a focused utility for creating ambient beds and atmospheres. Exports create licensed audio
              files you can use in videos, games, applications, podcasts, or client work.
            </p>

            <p className="mt-4 text-sm text-muted leading-relaxed">
              No profiles to manage. No dashboards to monitor. No “feed”. It behaves predictably and consistently.
            </p>
          </section>
          ...
          <section className="glass-panel elev-1 mt-8 rounded-3xl p-8">
            ...
            <ul className="mt-6 space-y-4 text-sm text-muted">
              <li>
                ...
                <br />
                It should work without configuration or explanation.
              </li>
              <li>
          ...
          <section className="glass-panel elev-1 mt-8 rounded-3xl p-8">
            ...
            <p className="mt-4 text-sm text-muted leading-relaxed">Soundscape uses real-world field recordings.</p>

            <p className="mt-4 text-sm text-muted leading-relaxed">
              Wind moves unevenly. Fire crackles imperfectly. Water shifts and drifts. Synthetic systems often smooth
              these details away. We keep them.
            </p>

            <p className="mt-4 text-sm text-muted leading-relaxed">We curate reality instead of sterilizing it.</p>
          </section>
          ...
          <section className="glass-panel elev-1 mt-8 rounded-3xl p-8">
            ...
            <p className="mt-4 text-sm text-muted leading-relaxed">
              Every generated mix is reproducible. Exports include a recipe description so mixes can be recreated and
              verified later.
            </p>
          ...
          <section className="glass-panel elev-1 mt-8 rounded-3xl p-8">
            ...
            <p className="mt-4 text-sm text-muted leading-relaxed">
              ...
              information (such as name and email) to complete the transaction. Soundscape does not store full payment
              details.
            </p>
          ...
          <section className="glass-panel elev-1 mt-8 rounded-3xl p-8">
            ...
            <p className="mt-4 text-sm text-muted leading-relaxed">
              The asset library grows intentionally. New recordings are added through curated real-world capture — not
              algorithmic generation. Expansion is deliberate. Quality comes before quantity.
            </p>
          </section>
        </div>
      </div>
