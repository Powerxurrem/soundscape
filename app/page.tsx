      ...
      <div className="relative mx-auto max-w-5xl px-6 py-14">
            ...
            <div className="w-full md:w-[320px]">
              <div className="rounded-2xl border border-white/15 bg-white/[0.02] p-4">
                ...
                <div className="mt-3 grid gap-2 text-sm">
                  <a
                    href="/autopilot"
                    className="rounded-xl border border-white/10 bg-white/[0.02] px-4 py-2 hover:bg-white/[0.06]"
                  >
                    → Autopilot (one-click)
                  </a>
                  <a
        ...
        <section className="mt-10 rounded-3xl border border-white/15 bg-white/[0.03] p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_40px_120px_rgba(0,0,0,0.65)] backdrop-blur">
          ...
          <div className="mt-7 grid gap-5 lg:grid-cols-3">
            {/* now playing */}
            <div className="lg:col-span-2 rounded-2xl border border-white/15 bg-white/[0.02] p-5">
          ...
          <div className="mt-6 text-xs text-white/45">
            Tip: Autopilot generates a deterministic mix from available assets. Mixer gives manual control.
          </div>
        </section>
      </div>
    </main>
